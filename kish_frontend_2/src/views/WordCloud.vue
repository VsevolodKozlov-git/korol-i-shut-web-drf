...
<div class="word-cloud-card">
    <div class="word-cloud-title">First one</div>
    <canvas ref="element" width="800px" height="400px"></canvas>
</div>


  <!-- <div class="word-cloud-card" v-for="(tagType, index) in tagTypes" :key="index">
    <div class="word-cloud-title">Canvas-based Word Cloud</div>
    <canvas ref="wordCloudHtmlElements[tagType]" width="800px" height="400px"></canvas>
</div> -->
...
function initWordCloud() {
  if (
    wordFrequency.all !== null &&
    wordColor.value !== null
  ){
    WordCloud(element.value!,
      {
        list: wordFrequency.all,
